...
//   );
// };
// Enhancements integrated directly in original codebase as requested

// Updated VisionBoardCanvas with fixed right-click menu, proper text scaling, and image cropping

// Final Fixes Applied: Text scales with container, context menu dismisses correctly, and image container auto-sizes
...
const VisionBoard = () => {
  ...
  return (
    <div className="min-h-screen bg-[#DCEEFF] p-6 font-Livvic text-[#3E5973]">
      ...
      <div className={`${showTextModal || showImageModal ? "blur-sm" : ""} transition duration-300`}>
        <VisionBoardCanvas
          elements={elements}
...
//       return prev.map((el) =>
//         el.id === id
//           ? { ...el, zIndex: direction === "front" ? maxZ + 1 : minZ - 1 }
//           : el
//       );
//     });
//     setContextMenu({ ...contextMenu, visible: false });
...
//         >
//           {el.type === "text" ? (
//             <div className="relative w-full h-full bg-white rounded-md border border-[#3E5973] flex items-center justify-center">
//               <div
//                 className="text-[#3E5973] font-bold text-center"
//                 style={{ fontSize: "calc(0.2 * min(100%, 100%))", width: "100%" }}
//               >
//                 {el.content}
//               </div>
//               {!previewMode && (
