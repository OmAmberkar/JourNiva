...
const SettingsModal = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-70 flex items-center justify-center backdrop-blur-sm bg-black/30 text-[var(--color-dark)]">
      <div className="bg-[var(--color-sidebar)] rounded-2xl p-8 shadow-2xl w-[90%] max-w-xl animate-settingsOpen border border-[var(--color-dark)]">
        {/* Header */}
        <div className="flex justify-between items-center mb-6">
          ...
          <button
            onClick={onClose}
            className="text-4xl text-[var(--color-dark)] hover:text-[#2c4258] transition cursor-pointer"
          >
            &times;
          </button>
        </div>
        ...
        {/* Settings Fields */}
        <div className="space-y-6 text-[var(--color-dark)]">
          {/* Display Name */}
          <div>
            ...
            <input
              ...
              className="w-full border border-[var(--color-dark)] px-4 py-2 rounded-lg text-black outline-none focus:ring-1 focus:ring-[#435e79]"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full border border-[var(--color-dark)] px-4 py-2 rounded-lg text-black cursor-pointer outline-none focus:ring-1 focus:ring-[#435e79]"
            />
          </div>
        ...
        <div className="flex justify-between pt-6">
          <button
            onClick={handleSave}
            className="bg-[var(--color-dark)] hover:bg-[#2c4258] text-white font-semibold py-2 px-8 rounded-lg transition duration-200 cursor-pointer"
          >
            Save
          </button>
          <button
