...
const Navbar = () => {
  ...
  return (
    ...
    <nav className="w-full sticky top-0 z-50 flex items-center justify-between px-4 md:px-6 py-2 bg-[#DCEFFF]/60 backdrop-blur-md border-b-2 border-[#3E5973] shadow-md">
      {/* Logo + Brand */}
      ...
      {menuOpen && (
        <ul className="absolute top-20 right-4 w-64 bg-[#dcefff]/80 backdrop-blur-md border border-[#3E5973] flex flex-col items-center text-[#3E5973] text-base font-medium gap-4 py-4 px-6 md:hidden z-50 shadow-xl rounded-xl">
          ...
          <li>
            <button className="w-[104px] bg-[#a8b4d0] text-white px-4 py-1 rounded-md hover:bg-[#9aa7c1]">
              Login
            </button>
          </li>
        </ul>
